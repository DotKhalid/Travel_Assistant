    ...
    with solara.Column(
        ...
        with solara.Row(justify="space-between"):
            with solara.Row(gap="10px", style={"align-items": "center"}):
                ...
                solara.HTML(
                    tag="h2",
                    unsafe_innerHTML="Traveller's Assistant",
            ...
            with solara.Row(
                ...
                with solara.Row(gap="5px", style={"align-items": "center"}):
                    solara.Text("Rehan Labs:", style="font-weight: bold;")
                    # target="_blank" links are still easiest to do via ipyvuetify
                    with solara.v.Btn(
                        icon=True,
                        tag="a",
                        attributes={
                            "href": "https://rehanlabs.com/",
                            "title": "rehan labs",
                            "target": "_blank",
                        },
                    ):
                        solara.v.Icon(children=["mdi-alpha-r-box"])
                with solara.Row(gap="5px", style={"align-items": "center"}):
                    solara.Text("Made by Khalid:", style="font-weight: bold;")
                    with solara.v.Btn(
                        icon=True,
                        tag="a",
                        attributes={
                            "href": "https://khalid.rehanlabs.com/",
                            "title": "Khalid",
                            "target": "_blank",
                        },
                    ):
                        solara.v.Icon(children=["mdi-alpha-k-box"])
                    ...
                    with solara.v.Btn(
                        ...
                        solara.v.Icon(children=["mdi-youtube"])
